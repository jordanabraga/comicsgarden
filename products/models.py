...
class Artist(models.Model):
    ...
    description = models.TextField(
        blank=True, default="This is a great artist."
    )
...
class Product(models.Model):
    ...
    cover_type = models.CharField(
        max_length=50, choices=COVER_TYPE_CHOICES, blank=True
    )
    color_option = models.CharField(
        max_length=20, choices=COLOR_CHOICES, default='colour'
    )
